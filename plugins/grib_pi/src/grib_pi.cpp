...
bool GribPi::LoadConfig() {
  ...
  pConf->Read("ZoomToCenterAtInitExplicit", &m_bZoomToCenterAtInitExplicit,
              false);
  if (m_bZoomToCenterAtInitExplicit)
    pConf->Read("ZoomToCenterAtInit", &m_bZoomToCenterAtInit, false);
  else {
    bool legacyZoomToCenter = false;
    pConf->Read("ZoomToCenterAtInit", &legacyZoomToCenter, false);
    m_bZoomToCenterAtInit = false;
...
bool GribPi::SaveConfig(void) {
  ...
  pConf->Write("ZoomToCenterAtInitExplicit",
