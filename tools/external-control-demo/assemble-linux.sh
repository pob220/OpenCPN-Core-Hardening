...
| Weather Routing 1.17.7.0 chart-aware provider (isolated xWeatherRouting identity) | 15c1369b6fbd71715dac598688c1b733a6e4fe7b (adds selectable Main and memory-budgeted Quick engines, five selectable GSHHS shoreline levels, chart-aware shoreline policy, preserved configuration and improved Main-engine arrival handling) |
