...
| Weather Routing 1.17.5.0 chart-aware provider (isolated xWeatherRouting identity) | 39a8f88e2fa2528f603b113443e446b22ba7e481 (adds bounded ocean-detour recovery, explicit depth prerequisites, per-route worker progress and safe GPX filenames; retains prior routing fixes) |
